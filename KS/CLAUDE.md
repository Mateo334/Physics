...
- You may create up to 10 subfolders in this directory, each corresponding to a distinct approach or method of calculation. For each one, name it accordingly.
- include the .py files tha you are using in the corresponding subfolder. 
