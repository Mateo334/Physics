...
$(\sigma/\mu)$, and $\sigma D^{3/2}$ for $D=2,4,8,16,32,64$.
All from $2\times10^5$ Haar-random $\mathrm{U}(D)$ unitaries.}
\label{tab:concentration}
\begin{tabular}{c|c|c|c|c}
$D$ & $\mathbb{E}[r_2]$ & $\sigma[r_2]$ & $\sigma/\mathbb{E}[r_2]$ & $\sigma\cdot D^{3/2}$ \\
\hline
2 & 0.6666 & 0.1490 & 0.2235 & 0.421 \\
4 & 0.4000 & 0.0654 & 0.1636 & 0.524 \\
8 & 0.2222 & 0.0221 & 0.0994 & 0.500 \\
16 & 0.1176 & 0.0065 & 0.0556 & 0.418 \\
32 & 0.0606 & 0.0018 & 0.0294 & 0.322 \\
64 & 0.0308 & 0.0005 & 0.0152 & 0.239 \\
\end{tabular}
\end{table}
...
\]
Asymptotically, $\sigma[r_2]/\mathbb{E}[r_2] = O(D^{-1/2})$ (Table~\ref{tab:concentration}).
...
The dominant cancellation leaves $\operatorname{Var}[r_2]=O(D^{-3})$, giving $\sigma=O(D^{-3/2})$
and $\sigma/\mu=O(D^{-3/2})/O(D^{-1})=O(D^{-1/2})$.
...
\item Proposition~\ref{prop:var_formula}: $\operatorname{Var}[r_2]=(A-\mu^2)+2(D-1)(B-\mu^2)+(D-1)^2(F-\mu^2)$,
  where $A=24/\mathrm{poch}(D,4)$, $B=4/\mathrm{poch}(D,4)$ (exact), $F=\mathbb{E}[|U_{11}|^4|U_{22}|^4]$ (numerical).
...
\item Proposition~\ref{prop:conc_r2}: $\sigma[r_2]/\mathbb{E}[r_2]=O(D^{-1/2})\to0$;
